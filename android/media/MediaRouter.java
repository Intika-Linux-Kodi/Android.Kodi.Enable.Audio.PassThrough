...
public class MediaRouter {
    ...
    public static class RouteInfo {
        ...
        class C04951 extends Stub {
            ...
            public void dispatchRemoteVolumeUpdate(int direction, int value) {
                MediaRouter.sStatic.mHandler.post(new C04941(direction, value));
            }
        }
        ...
        RouteInfo(RouteCategory category) {
            ...
            this.mEnabled = true;
            this.mRemoteVolObserver = new C04951();
        ...
        public int getVolume() {
            ...
            try {
                ...
                Log.m3e(MediaRouter.TAG, "Error getting local stream volume", e);
                return vol;
            }
        }
        ...
        public void requestSetVolume(int volume) {
            if (this.mPlaybackType == 0) {
                try {
                    ...
                    Log.m3e(MediaRouter.TAG, "Error setting local stream volume", e);
                    return;
                }
            }
    ...
    static class Static implements DisplayListener {
        ...
        class C04971 extends IAudioRoutesObserver.Stub {
            ...
            class C04961 implements Runnable {
                ...
                C04961(AudioRoutesInfo audioRoutesInfo) {
            ...
            public void dispatchAudioRoutesChanged(AudioRoutesInfo newRoutes) {
                Static.this.mHandler.post(new C04961(newRoutes));
            }
        }
        ...
        final class Client extends IMediaRouterClient.Stub {
            ...
            public void onStateChanged() {
                Static.this.mHandler.post(new C04981());
            }
        }
        ...
        Static(Context appContext) {
            ...
            this.mAudioRoutesObserver = new C04971();
            ...
            this.mSystemCategory = new RouteCategory(17040851, 3, (boolean) MediaRouter.DEBUG);
        ...
        void startMonitoringRoutes(Context appContext) {
            ...
            this.mDefaultAudioVideo.mNameResId = 17040847;
            ...
            if (!TextUtils.equals(newRoutes.mBluetoothName, this.mCurAudioRoutesInfo.mBluetoothName)) {
                ...
                if (this.mCurAudioRoutesInfo.mBluetoothName != null) {
                    if (MediaRouter.sStatic.mBluetoothA2dpRoute == null) {
                        ...
                        info.mDescription = MediaRouter.sStatic.mResources.getText(17040852);
        ...
        boolean isBluetoothA2dpOn() {
            try {
                ...
                Log.m3e(MediaRouter.TAG, "Error querying Bluetooth A2DP state", e);
                return MediaRouter.DEBUG;
            }
        }
            ...
            if (this.mCurrentUserId != userId || userId < 0 || this.mClient == null) {
                if (this.mClient != null) {
                    try {
                        ...
                        Log.m3e(MediaRouter.TAG, "Unable to unregister media router client.", ex);
                    }
                    this.mClient = null;
                }
                ...
                try {
                    ...
                    Log.m3e(MediaRouter.TAG, "Unable to register media router client.", ex2);
                }
                publishClientDiscoveryRequest();
        ...
        void publishClientDiscoveryRequest() {
            if (this.mClient != null) {
                try {
                    ...
                    Log.m3e(MediaRouter.TAG, "Unable to publish media router client discovery request.", ex);
                }
            }
        }
        ...
        void publishClientSelectedRoute(boolean explicit) {
            if (this.mClient != null) {
                try {
                    ...
                    Log.m3e(MediaRouter.TAG, "Unable to publish media router client selected route.", ex);
                }
            }
        }
        ...
        void updateClientState() {
            ...
            if (this.mClient != null) {
                try {
                    ...
                    Log.m3e(MediaRouter.TAG, "Unable to retrieve media router client state.", ex);
                }
            }
            ...
            if (globallySelectedRouteId != null) {
                ...
                if (route == null) {
                    Log.m8w(MediaRouter.TAG, "Could not find new globally selected route: " + globallySelectedRouteId);
                } else if (route != this.mSelectedRoute) {
                    if (MediaRouter.DEBUG) {
                        Log.m0d(MediaRouter.TAG, "Selecting new globally selected route: " + route);
                    }
                ...
                if (MediaRouter.DEBUG) {
                    Log.m0d(MediaRouter.TAG, "Unselecting previous globally selected route: " + this.mSelectedRoute);
                }
                MediaRouter.selectDefaultRouteStatic();
            }
        ...
        void requestSetVolume(RouteInfo route, int volume) {
            if (route.mGlobalRouteId != null && this.mClient != null) {
                try {
                    ...
                    Log.m9w(MediaRouter.TAG, "Unable to request volume change.", ex);
                }
            }
        }
    ...
    public static class UserRouteInfo extends RouteInfo {
        ...
        class SessionVolumeProvider extends VolumeProvider {
            ...
            public void onSetVolumeTo(int volume) {
                MediaRouter.sStatic.mHandler.post(new C04991(volume));
            }

            public void onAdjustVolume(int direction) {
                MediaRouter.sStatic.mHandler.post(new C05002(direction));
            }
        }
        ...
        public void requestSetVolume(int volume) {
            ...
            if (this.mVcb == null) {
                Log.m2e(MediaRouter.TAG, "Cannot requestSetVolume on user route - no volume callback set");
            } else {
        ...
        public void requestUpdateVolume(int direction) {
            ...
            if (this.mVcb == null) {
                Log.m2e(MediaRouter.TAG, "Cannot requestChangeVolume on user route - no volumec callback set");
            } else {
        ...
        private void configureSessionVolume() {
            if (this.mRcc != null) {
                ...
                if (session == null) {
                    if (MediaRouter.DEBUG) {
                        Log.m0d(MediaRouter.TAG, "Rcc has no session to configure volume");
                    }
                ...
                Log.m0d(MediaRouter.TAG, "No Rcc to configure volume for route " + this.mName);
            }
        }
    }
    ...
    public void removeCallback(Callback cb) {
        ...
        Log.m8w(TAG, "removeCallback(" + cb + "): callback not registered");
    }
    ...
    static void selectRouteStatic(int types, RouteInfo route, boolean explicit) {
        ...
        if (oldRoute != route) {
            if (route.matchesTypes(types)) {
                ...
                if (!(btRoute == null || (types & ROUTE_TYPE_LIVE_AUDIO) == 0 || (route != btRoute && route != sStatic.mDefaultAudioVideo))) {
                    try {
                        ...
                        Log.m3e(TAG, "Error changing Bluetooth A2DP state", e);
                    }
                }
                ...
                if (activeDisplay != null || oldRouteHasAddress || newRouteHasAddress) {
                    if (!newRouteHasAddress || matchesDeviceAddress(activeDisplay, route)) {
                        ...
                        Log.m2e(TAG, "Cannot connect to wifi displays because this process is not allowed to do so.");
                    }
                }
            ...
            Log.m8w(TAG, "selectRoute ignored; cannot select route with supported types " + typesToString(route.getSupportedTypes()) + " into route types " + typesToString(types));
        }
    }
        ...
        if (selectedRoute != null) {
            if (selectedRoute == sStatic.mBluetoothA2dpRoute || selectedRoute == sStatic.mDefaultAudioVideo) {
                ...
                try {
                    ...
                    Log.m3e(TAG, "Error checking Bluetooth A2DP state to report volume change", e);
                }
            } else {
    ...
    static int getWifiDisplayStatusCode(WifiDisplay d, WifiDisplayStatus wfdStatus) {
        ...
        switch (wfdStatus.getActiveDisplayState()) {
            case Toast.LENGTH_SHORT /*0*/:
                Log.m2e(TAG, "Active display is not connected!");
                return newStatus;
    ...
    static RouteInfo makeWifiDisplayRoute(WifiDisplay display, WifiDisplayStatus wfdStatus) {
        ...
        newRoute.mDescription = sStatic.mResources.getText(17040853);
